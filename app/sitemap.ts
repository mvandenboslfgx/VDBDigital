...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = [
    ...
    { url: `${base}/website-scan`, lastModified: now, changeFrequency: "weekly" as const, priority: 0.95 },
    { url: `${base}/website-seo-check`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.9 },
    { url: `${base}/website-snelheid-test`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.9 },
    { url: `${base}/conversie-check`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.9 },
