        ...
        >
          {AUDIENCES.map((card) => (
            <motion.div
              ...
              className="flex min-h-[5rem] w-full items-center justify-center rounded-2xl border border-gray-200 bg-white px-5 py-5 shadow-saas-card transition-shadow duration-300 md:min-h-[6rem] md:px-6"
