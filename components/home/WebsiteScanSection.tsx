      ...
      <div className="section-container">
        <div className="mx-auto max-w-4xl">
          ...
          <motion.div
            ...
            className="mt-12 rounded-2xl border border-gray-200 bg-white p-8 shadow-saas-card transition-all duration-300"
          >
            ...
            <AnimatePresence mode="wait">
              {!scanning ? (
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="rounded-2xl border border-gray-200 bg-white p-8 shadow-saas-card max-w-2xl mx-auto"
                >
