...
export default function FinalCtaSection() {
  return (
    <section className="relative py-24 md:py-32">
      <motion.div
        className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_70%_50%_at_50%_100%,rgba(198,169,93,0.06),transparent)]"
        initial={{ opacity: 0 }}
      ...
      <div className="section-container">
        <motion.div
          ...
          className="mx-auto max-w-3xl rounded-2xl border border-marketing-border bg-white p-12 md:p-16 text-center shadow-marketing-card-hover transition-shadow duration-300"
        >
