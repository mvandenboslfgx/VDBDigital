          ...
          >
            <motion.div className="w-full sm:flex-1" whileFocus={{ scale: 1.01 }} transition={{ duration: 0.2 }}>
              <input
                ...
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-4 text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 text-base transition-all"
