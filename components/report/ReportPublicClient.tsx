...
import { ReviewTaco } from "@/components/dashboard/ReviewTaco";
...
export interface ReportPublicClientProps {
  ...
  /** Relevant partner ad based on lowest score (with budget check) */
  recommendedAd?: RelevantAd | null;
  recommendedToolsMetric?: string;
}
    ...
    <div className="min-h-screen bg-[#0a0a0b] text-white">
      <div className="section-container py-12 md:py-16">
        <div className="mx-auto max-w-3xl">
          ...
          {recommendedAd && recommendedToolsMetric && (
            <AdBanner ad={recommendedAd} metricLabel={recommendedToolsMetric} />
          )}
