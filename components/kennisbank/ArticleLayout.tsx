          ...
          <article className="min-w-0">
            ...
            >
              ...
              <ul className="mt-4 flex flex-wrap gap-x-6 gap-y-2">
                ...
                <li>
                  <Link href="/calculators" className="text-gold hover:text-goldHover hover:underline">
                    Calculators
                  </Link>
                </li>
              </ul>
                ...
                <ul className="mt-4 space-y-2">
                  {toc.map((item) => (
                    ...
                    >
                      <a
                        href={`#${item.id}`}
                        className="text-sm text-marketing-textSecondary hover:text-gold transition-colors"
                      >
                        {item.text}
                      </a>
                    </li>
